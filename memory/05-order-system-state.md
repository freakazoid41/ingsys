...
> **⚠️ 2026-09-03 late: `/tedarikpanel/documents` `DList` row restyled to match OList CardRow — `tr` white/radius14px/0 2px 8px shadow + `td` transparent borderless (fixes midline dividers), tedarik `75vh` height, Kullanıcılar tab removed. See §4 Files Changed.**
