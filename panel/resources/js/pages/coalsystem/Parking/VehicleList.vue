<script>
    ...
    export default {
        breadcrumbs: {
            list: [ { title: 'Vehicles', path: '/coalpanel/vehicles' } ],
            title: 'Vehicles'
        },
        setup() {
                ...
                const headers = [
                    {
                        ...
                        columnFormatter : (elm,rowData,columnData) => {
                            ...
                            editBtn.onclick = () => this.$router.push({ name: 'VehicleForm', params: { id: columnData } });
        ...
        <div class="card-header rlist-header">
            <div class="rlist-search-group">
                <div class="rlist-search-wrap">
                    ...
                    <input type="text" id="mainSearch" class="rlist-search-input" placeholder="Search vehicles...">
                </div>
            ...
            <div class="rlist-toolbar">
                <router-link :to="{ name: 'VehicleForm' }" class="rlist-btn rlist-btn-create">
                    <i class="ki-outline ki-plus fs-5"></i> Add Vehicle
                </router-link>
            </div>
        </div>
