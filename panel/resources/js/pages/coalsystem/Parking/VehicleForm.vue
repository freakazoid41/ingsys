<script>
    ...
    export default {
        breadcrumbs: {
            list: [ { title: 'Vehicles', path: '/coalpanel/vehicles' }, { title: 'Vehicle Add / Edit', path: '#' } ],
            title: 'Vehicle Add / Edit'
        },
        components: { Form },
        setup() {
            return {
        ...
        methods: {
            async submitForm(formData){
                ...
                this.navigationStore.toggle(true);
                this.formData.typeKey = 'op-doc-vehicle';
...
<template>
    <Form formtypes="op-doc-vehicle-form" v-if="loadForm" :savecallback="submitForm" savebtntitle="Save Vehicle" />
</template>
