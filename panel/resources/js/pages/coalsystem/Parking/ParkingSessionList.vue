<script>
    ...
    export default {
        breadcrumbs: {
            list: [ { title: 'Parking Sessions', path: '/coalpanel/parking-sessions' } ],
        ...
        methods: {
            ...
            buildTable(){
                const headers = [
                    { title : 'Session', key : 'title', order : true, type : 'string' },
                    { title : 'Plate', key : 'vehicle_plate', order : true, type : 'string' },
                    { title : 'Spot', key : 'parking_spot', order : true, type : 'string' },
                    { title : 'Entry', key : 'entry_time', order : true, type : 'string' },
                    { title : 'Exit', key : 'exit_time', order : true, type : 'string' },
                    ...
                    { title : 'Actions', key : 'id', order : false, type : 'string', columnFormatter : (elm,rowData,columnData) => {
                            ...
                            editBtn.onclick = () => this.$router.push({ name: 'ParkingSessionForm', params: { id: columnData } });
        ...
        <div class="card-header rlist-header">
            <div class="rlist-search-group">
                <div class="rlist-search-wrap">
                    ...
                    <input type="text" id="mainSearch" class="rlist-search-input" placeholder="Search sessions...">
                </div>
            ...
            <div class="rlist-toolbar">
                <router-link :to="{ name: 'ParkingSessionForm' }" class="rlist-btn rlist-btn-create">
                    <i class="ki-outline ki-plus fs-5"></i> Add Session
                </router-link>
            </div>
        </div>
