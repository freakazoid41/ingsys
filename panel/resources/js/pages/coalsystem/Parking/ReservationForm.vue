<script>
    ...
    export default {
        breadcrumbs: {
            list: [ { title: 'Reservations', path: '/coalpanel/reservations' }, { title: 'Reservation Add / Edit', path: '#' } ],
            title: 'Reservation Add / Edit'
        },
        components: { Form },
        setup() {
            return {
        ...
        methods: {
            async submitForm(formData){
                ...
                this.navigationStore.toggle(true);
                this.formData.typeKey = 'op-doc-reservation';
...
<template>
    <Form formtypes="op-doc-reservation-form" v-if="loadForm" :savecallback="submitForm" savebtntitle="Save Reservation" />
</template>
