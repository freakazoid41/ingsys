<script>
    ...
    export default {
        breadcrumbs: {
            list: [ { title: 'Parking Spots', path: '/coalpanel/parking-spots' }, { title: 'Spot Add / Edit', path: '#' } ],
            title: 'Spot Add / Edit'
        },
        components: { Form },
        setup() {
        ...
        methods: {
            async submitForm(formData){
                ...
                this.navigationStore.toggle(true);
                this.formData.typeKey = 'op-doc-parking-spot';
...
<template>
    <Form formtypes="op-doc-parking-spot-form" v-if="loadForm" :savecallback="submitForm" savebtntitle="Save Spot" />
</template>
