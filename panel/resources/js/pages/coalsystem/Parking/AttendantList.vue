<script>
    ...
    export default {
        breadcrumbs: {
            list: [ { title: 'Attendants', path: '/coalpanel/attendants' } ],
            title: 'Attendants'
        },
        setup() {
        ...
        methods: {
            ...
            buildTable(){
                const headers = [
                    { title : 'Name', key : 'title', order : true, type : 'string' },
                    { title : 'Employee ID', key : 'employee_id', order : true, type : 'string' },
                    { title : 'Shift', key : 'shift', order : true, type : 'string' },
                    { title : 'Phone', key : 'phone', order : true, type : 'string' },
                    { title : 'Email', key : 'email', order : true, type : 'string' },
                    { title : 'Actions', key : 'id', order : false, type : 'string', columnFormatter : (elm,rowData,columnData) => {
                            ...
                            editBtn.onclick = () => this.$router.push({ name: 'AttendantForm', params: { id: columnData } });
                ...
                this.table = new PickleTable({
                    ...
                    initialFilter : [
                        { key:'form-type', type:'=', value:'op-doc-attendant-form' },
                        { key:'type', type:'=', value:'op-doc-attendant' },
                    ],
        ...
        <div class="card-header rlist-header">
            <div class="rlist-search-group">
                <div class="rlist-search-wrap">
                    ...
                    <input type="text" id="mainSearch" class="rlist-search-input" placeholder="Search attendants...">
                </div>
            ...
            <div class="rlist-toolbar">
                <router-link :to="{ name: 'AttendantForm' }" class="rlist-btn rlist-btn-create">
                    <i class="ki-outline ki-plus fs-5"></i> Add Attendant
                </router-link>
            </div>
        </div>
