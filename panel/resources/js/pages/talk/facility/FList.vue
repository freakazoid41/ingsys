                ...
                const headers = [
                   /*{
                        ...
                        columnFormatter : (elm,rowData,columnData) => {
                            ...
                            edit.href        = '/talkpanel/flist/form/'+columnData;
...
<template>
    ...
    <div class="table-tab">
        <div class="table-tab-head">
            <button href="javascript:;" class="table-toggle active" body="1">{{ $t('form.facility.list') }}</button>
            <router-link :to="{ name: 'FForm' }"><button class="table-toggle" body="2">{{ $t('form.facility') }}</button></router-link>
        </div>
        <div class="table-tab-body">
            <div class="table-custom-filter mb-5">
                ...
                <div class="table-custom-filter-button-group">
                    <button class="export-excel" onclick="window.location.href='/export/documents/facility'" id="exportExcel">Excel’e Aktar</button>
                </div>
