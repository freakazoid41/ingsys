...
<template>
    <div class="table-tab">
        <div class="table-tab-head">
            <router-link :to="{ name: 'FList' }"><button class="table-toggle" body="1">{{ $t('form.facility.list') }}</button></router-link>
            <button class="table-toggle active" body="2">{{ $t('form.facility') }}</button>
        </div>
