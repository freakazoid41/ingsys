...
<template>
    <div class="table-tab">
        <div class="table-tab-head">
            <router-link :to="{ name: 'FList' }"><button class="table-toggle" body="1">Liste</button></router-link>
            <button class="table-toggle active" body="2">Form</button>
        </div>
        <div class="table-tab-body">
            <div class="body-1 table-main"  >
                <TalkForm formtypes="op-doc-flat-form" v-if="loadForm" :savecallback="submitForm" />
                <!--<Transactions  :id="id"/>-->
            </div>
        </div>
    </div>
