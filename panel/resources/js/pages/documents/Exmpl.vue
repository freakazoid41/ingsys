        ...
        mounted(){
            this.forms = {
                'op-doc-per-edu' : {
                    ...
                    oncreated        : (id) => {
                        document.getElementById('op-doc-per-edu-alckttrlr-subadd-'+id).click();
                    },
                    fields           : [
                        {
            ...
            this.buildDynamicFForm('op-doc-per-edu','new-'+(new Date).getTime()+'-1');
                ...
                for (let index = 0; index < form.fields.length; index++) {
                    ...
                    switch (fitem.type) {   
                        ...
                        case 'multiple':
                            ...
                            icon.id = tag+'-'+fitem.group_key+'-subadd-'+rowId;
