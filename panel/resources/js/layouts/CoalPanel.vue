...
import Sidebar from '@/components/coalparts/Sidebar.vue';
import Header from '@/components/coalparts/Header.vue'
...
<template>
    <div class="page d-flex flex-row flex-column-fluid">
       <div class="preloader" id="page-loader1"  v-show="navigationStore.active">
