export default class Plib {
    ...
    validatePassword(input) {
        ...
        const checks = [
            [p.length >= 8, "Parola en az 8 karakterden oluşmalıdır.."],
            [/[a-z]/.test(p), "Parolada en az 1 küçük harf bulunmalıdır.."],
            [/[A-Z]/.test(p), "Parolada en az 1 büyük harf bulunmalıdır.."],
            [/[0-9]/.test(p), "Parolada en az 1 rakam bulunmalıdır.."],
            [/[^A-Za-z0-9]/.test(p), "Parolada en az 1 özel karakter bulunmalıdır.."]
        ];
